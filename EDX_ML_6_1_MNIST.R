...
# Note that the line above is the correct code 
x_test <- mnist$test$images[index,]
y_test <- factor(mnist$test$labels[index])

# Preprocessing:
# Common preprocessing steps include:
#   1. standardizing or tranforming predictors and
...
# The correct package requires that we add column names to the feature matrices
